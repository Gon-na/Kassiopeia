...
Secondly, in order to build *Kassiopeia*, CMake version CMakeVersion_ or greater is needed, along with a suitable build tool such
...
- g++ version |g++Version| or higher (if compiling with GCC_)
- clang++ version |clang++Version| or higher (if compiling with Clang_)
- GSL_
...
.. |g++Version| replace:: 6.1
.. |clang++Version| replace:: 3.4
.. |gccVersion| replace:: 5.0
